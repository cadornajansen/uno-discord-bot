...
PET_CATALOG: dict[str, dict] = {
    "tuxedo_cat": {
        ...
        "favorite_snack": "🐟 Fresh Intramuros Tuna Treats",
        "duel_perk": "🐾 Feline Agility: +10% Dodge in RPG Arena Combat",
        "quotes": [
    ...
    "calico_cat": {
        ...
        "rival_with": "🦊 Arctic Fox, 🐍 Serpents",
        "favorite_snack": "🥛 Warm Sweet Milk Biscuits",
        "duel_perk": "🐾 Feline Agility: +10% Dodge in RPG Arena Combat",
        "quotes": [
    ...
    "golden_dog": {
        ...
        "favorite_snack": "🍖 Roasted Beef Marrow Bones",
        "duel_perk": "🐶 Intimidating Bark: 20% chance to reduce opponent roll/damage by 15",
        "quotes": [
    ...
    "shiba_dog": {
        ...
        "rival_with": "🦊 Arctic Fox, 🦹 Classmate Thieves",
        "favorite_snack": "🥩 Crispy Wagyu Jerky Bites",
        "duel_perk": "🐶 Intimidating Bark: 20% chance to reduce opponent roll/damage by 15",
        "quotes": [
    ...
    "brown_bunny": {
        ...
        "favorite_snack": "🥕 Sweet Organic Clover Crunch",
        "duel_perk": "🐰 Lucky Reroll: Auto-rerolls dice under 30 & +15% RPG Ultimate hit rate",
        "quotes": [
    ...
    "white_bunny": {
        ...
        "rival_with": "🦉 Frost Owl, 🦊 Arctic Fox",
    ...
    "scholar_owl": {
        ...
        "favorite_snack": "🫐 Smart Energy Acorn Berries",
        "duel_perk": "🦉 Calculated Strike: +10 clutch roll bonus in close duel clashes",
        "quotes": [
    ...
    "ice_owl": {
        ...
        "perk_title": "Quiz Master (+25 pts/quiz & 4th Attempt)",
        "perk_desc": "Earns +75 pts per correct trivia quiz and unlocks a 4th daily trivia quiz attempt!",
        "friendly_with": "🐶 Shiba Inu, 🦊 Arctic Fox",
        "rival_with": "🐠 Fiery Goldfish, 🐰 Moon Rabbit",
        "favorite_snack": "❄️ Glacial Frost Berries",
        "duel_perk": "🦉 Calculated Strike: +10 clutch roll bonus in close duel clashes",
        "quotes": [
    ...
    "oogway_turtle": {
        ...
        "rival_with": "⚡ Impatient Rerollers, 🌪️ Haste",
        "favorite_snack": "🍑 Sacred Peach Tree Blossoms",
    ...
    "orange_fox": {
        ...
        "favorite_snack": "🍗 Stolen Canteen Chicken Skewers",
        "duel_perk": "🦊 Consolation Siphon: 25% chance on loss to siphon back 20% of lost wager",
        "quotes": [
    ...
    "ice_fox": {
        ...
        "favorite_snack": "🧊 Frozen Smoked Salmon Flakes",
        "duel_perk": "🦊 Consolation Siphon: 25% chance on loss to siphon back 20% of lost wager",
        "quotes": [
    ...
    "pink_axolotl": {
        ...
        "favorite_snack": "🦐 Tiny Hydro Gel Shrimp",
    ...
    "rainbow_axolotl": {
        ...
        "rival_with": "🌪️ Monotone Voids, 📉 Point Audits",
    ...
    "fiery_goldfish": {
        ...
        "rival_with": "🦉 Frost Owl, ❄️ Ice Creatures",
        "favorite_snack": "✨ Blazing Fortune Pellets",
